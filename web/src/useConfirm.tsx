 ...
 * l'addon (mêmes classes .modal-* que le formulaire produit). Retourne
 * `[confirm, modalElement]` — `confirm(opts)` est async, comme un
 * `window.confirm()`, `modalElement` doit être rendu une fois dans le JSX
